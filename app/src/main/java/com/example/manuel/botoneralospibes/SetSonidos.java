...
public class SetSonidos {
    ...
    private static SetSonidos our_instance = new SetSonidos();
    ...
    public void reprodcir(int id_sonido_a_reproducir) {
        sound_pool.play(mapa_sonidos.get(id_sonido_a_reproducir), volume, volume, priority, no_loop, normal_playback_rate);
